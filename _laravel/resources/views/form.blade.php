...
@section('cuerpo')
    <q-page class="q-ma-md">
        ...
        <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
            ...
            <div class="col-6">
                <q-input clearable outlined v-model.number="state.f.numero" type="number" label="Número"
                    :error="typeof state.errors.numero !== 'undefined'" :error-message="state.errors.numero">
                </q-input>
            </div>
            <div class="col-6">
                <q-input clearable v-model="state.f.fecha" type="date" label="Fecha" :error="state.errors.fecha"
                    :error-message="state.errors.fecha"></q-input>
            </div>
            <div>
                <q-toggle v-model="state.accept" label="I accept the license and terms"></q-toggle>
            </div>
            <div class="row mt-3">
                <div class="col-4">
